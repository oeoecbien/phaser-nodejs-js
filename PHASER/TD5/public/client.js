...
function addPlayer(self, playerInfo) {
    ...
    self.physics.add.collider(player, otherPlayers, handleCollision);
}
...
function handleCollision(player, otherPlayer) {
    console.log('Collision detected!');
    // Gérer la logique de collision (par exemple, réduire la vie)
}